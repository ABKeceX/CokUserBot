...
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
    await typew.edit(f"**Haii Salken Cok, Saya {DEFAULTUSER}**")
    sleep(2)
    await typew.edit("**Assalamualaikum...Cok? Pada Mati Ya**")


@register(outgoing=True, pattern=r"^\.l(?: |$)(.*)")
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit("**Wa'alaikumsalam Cok**")
...
CMD_HELP.update(
    {
        ...
        \n\n  •  **Syntax :** `.k`\
        \n  •  **Function : **LU SEMUA NGENTOT COKK🔥😎\
        \n\n  •  **Syntax :** `.j`\
